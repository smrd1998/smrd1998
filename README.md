# Hi there 👋, I'm Mohammad Reza Dehghani

**Senior Front-End Developer | Vue.js & React Native Enthusiast**

Welcome to my GitHub profile! I am a passionate Front-End Developer with over 6 years of experience building scalable web applications, cross-platform mobile apps, and complex CRM dashboards. 

### 👨‍💻 About Me
- 🔭 I’m currently focused on building advanced Client-Side Web Applications.
- 🌱 My core stack includes **Vue.js, Nuxt.js, React Native, and Vanilla JavaScript**.
- 💡 I love turning complex problems into simple, beautiful, and intuitive UI designs.
- 📫 How to reach me: **smrd1377@gmail.com**

### 🛠️ My Tech Stack
- **Web:** Vue.js (Vuex, Vuetify), React.js, HTML5, CSS3, JavaScript (ES6+)
- **Mobile:** React Native, Kotlin (Android)
- **Tools:** Git, RESTful APIs, Adobe XD, Trello
